...
#include "RTClib.h"
bool last_start,last_up,last_adjs,last_down;
RTC_DS1307 rtc;
String  rctsdays;
int last_minutes;
char text[]={' ',' ',' ',' ',' ' };
...
void setup()
{
  ...
  uppt=false;
  downn=false;
//rtc.adjust(DateTime(2021, 01, 14, 15, 04, 0));
}
//---
...
ps=s-((ph*3600)+(pm*60));
 ...
 sps=String(ps);
  ...
  dmd.clearScreen( true );
   dmd.drawChar(0,0, sph[0], GRAPHICS_NORMAL );
   dmd.drawChar(6,0, sph[1], GRAPHICS_NORMAL );
